...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/hLBBAd06VE)
...
```sh
npx nx serve freedom-of-travel
```

To create a production bundle:

```sh
npx nx build freedom-of-travel
```

To see all available targets to run for a project, run:

```sh
npx nx show project freedom-of-travel
```
